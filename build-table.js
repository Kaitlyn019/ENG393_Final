let sources = [
    ...
    { name: "Student Organization Resource Center", description: "Also known as SORC, they are committed to helping student organizations and students meet. Follow their Facebook for event notifications (there are many during final seasons!)", link: "www.facebook.com/MarylandSORC" },
    { name: "SEE", description: "SEE offers prepares tons of events for students through out the semester from movie night to famous guest speakers and more!", link: "www.see.umd.edu/" },
    { name: "The Clarice", description: "Do you enjoy the arts? The Clarice has unique shows and projects for creative students!", link: "theclarice.umd.edu/"},
    { name: "SPS", description: "The Society of Physics Students is an opportunity to meet other physics majors. Try looking to see if your own major has an organization and support system!", link: "sps.physics.umd.edu/" },
